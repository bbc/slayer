...
var OPTIONS_DEFAULTS = {
  bufferingFactor: 4,           // if slayer.config.minPeakDistance equals to 45, we want to buffer and slide by 180 items each time
  lookAheadFactor: 0.33         // if we buffer 180 items, we actually provision an extra 30% (48) to look ahead
};
